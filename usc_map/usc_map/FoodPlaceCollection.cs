...
namespace usc_map
{
	static class FoodPlaceCollection
	{
		...
		public static void addAllFoodPlaces(MainPage mainPage)
		{
			...
			PlaceList.Add(new UscPlace(mainPage, "food", "Chipotle", "Burritos and burrito bowls with free-range meats and lots of options. Try an off-the-menu secret, a quesarrito (burrito and quesadilla cross-breed) and you won't be disappointed!",34.016707, -118.282575));
			PlaceList.Add(new UscPlace(mainPage, "food", "Chick-Fil-A", "Famous chicken sandwiches, waffle fries, and more. Make sure to come on Trojan Tuesdays to get sweet deals like free chicken sandwiches after 6pm.", 34.016578, -118.282591));
			PlaceList.Add(new UscPlace(mainPage, "food", "Lotus", "Tucked away behind Tuscany is this sushi and hookah bar. Hookah bar floor seating is rad, but if you're not looking to practice your smoke rings, there's also a dining room for non-hookah partakers. Try their small tea pots or share one with a friend- they're beautiful and delicious.", 34.017493, -118.281181));
			PlaceList.Add(new UscPlace(mainPage, "food", "Cups of Coffee", "Satisfy your coffee and espresso dreams right across the street from campus. This new coffee joint has reasonable prices and serves Groundwork coffee. Added bonus: also a great place to study or meet up with friends. Tip: Always order it to go (even if you're planning on hanging out) and you won't get charged for taxes.",34.022251, -118.279904));
			PlaceList.Add(new UscPlace(mainPage, "food", "Freebirds", "Great burritos and more. Often considered second rate to Chipotle, but they do have more options than Chipotle. Grab a \"pot brownie\" and a burrito for a quick dinner right off campus.", 34.022224, -118.280108));
			PlaceList.Add(new UscPlace(mainPage, "food", "Subway", "Your average Subway. Open late (2:30am)often.", 34.022802, -118.279572));
			PlaceList.Add(new UscPlace(mainPage, "food", "Pizza Studio", "Great thin crust personal pizzas line-style. Unlimited toppings for $8.", 34.018765, -118.281557));
			PlaceList.Add(new UscPlace(mainPage, "food", "Which Wich", "Sandwiches and great milkshakes. Tons of options. Try their Oreo milkshake", 34.018552, -118.281481));
			PlaceList.Add(new UscPlace(mainPage, "food", "Taco Bell", "Taco Bell on the west side of campus.", 34.022349, -118.291781));
			PlaceList.Add(new UscPlace(mainPage, "food", "Manas Indian Restaurant", "Great Indian food", 34.028955, -118.291792));
			PlaceList.Add(new UscPlace(mainPage, "food", "Ignatius Cafe", "One of the USC area's best kept secrets. Best lattes in walking distance of USC($3 donation, beans are carefully picked, roasted, and ground in-house). It is inside an old house that is now turned into all study rooms and owned by the Korean Catholic Church next door. Outside seating is beautiful. Hard to find from the street, but when you do, you'll be amazed.", 34.031792, -118.292940));
		}
